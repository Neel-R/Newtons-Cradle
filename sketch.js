...
function setup() {
	...
	constraint1 = new Rope(bob1,{x: 120, y: 50});
	constraint2 = new Rope(bob2,{x: 230, y: 50});
	constraint3 = new Rope(bob3,{x: 340, y: 50});
	constraint4 = new Rope(bob4,{x: 450, y: 50});
	constraint5 = new Rope(bob5,{x: 560, y: 50});
